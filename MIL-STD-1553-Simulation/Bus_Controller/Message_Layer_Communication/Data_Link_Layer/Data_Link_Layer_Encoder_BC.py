class DataLinkLayerEncoderBC:
    ...
    """
        ...
        | RT Address | R/T | Subaddress/Mode Code Representator | Word Count/
        Mode Code | 
    ...
    def build_cmd_word(self, cmd_word):
        try:
            ...
            # Input value of 0x00 or 0x1f says that next 5 bits will be a
            # Mode Code
            ...
            # Next 2 characters from input represent 5 bit Word Count or
            # Mode Code
